...
CASES = [
    ...
    {
        "case": 1,
        "accession": "GCST008396",
        "expected_min_ancestry_len": 1,
        "expected_min_EFO_len": 1,
        "expected_min_genotyping_technology": 1,
        "notes": "single ancestry",
        "api_call_from": "rest_api",
    },
    {
        "case": 2,
        "accession": "GCST006186",
        "expected_min_ancestry_len": 5,
        "expected_min_EFO_len": 2,
        "expected_min_genotyping_technology": 1,
        "notes": "multi ancestry",
        "api_call_from": "rest_api",
    },
    {
        "case": 3,
        "accession": "GCST005544",
        "expected_min_ancestry_len": 1,
        "expected_min_EFO_len": 1,
        "expected_min_genotyping_technology": 3,
        "notes": "multi ancestry",
        "api_call_from": "rest_api",
    },
    # ingest api
    {
        "case": 4,
        "accession": "GCST90018791",
        "expected_min_ancestry_len": 4,
        "expected_min_EFO_len": 1,
        "expected_min_genotyping_technology": 1,
        "notes": "multi ancestry",
        "api_call_from": "ingest_api",
    },
    {
        "case": 5,
        "accession": "GCST90011787",
        "expected_min_ancestry_len": 1,
        "expected_min_EFO_len": 0,
        "expected_min_genotyping_technology": 2,
        "notes": "published study but no efo trait",
        "api_call_from": "ingest_api",
    },
    {
        "case": 6,
        "accession": "GCST90012203",
        "expected_min_ancestry_len": 1,
        "expected_min_EFO_len": 6,
        "expected_min_genotyping_technology": 1,
        "notes": " efo_trait : EFO_0004348,EFO_0004528,EFO_0004527,EFO_0004526,EFO_0004305,EFO_0005192",
        "api_call_from": "ingest_api",
    },
    {
        "case": 7,
        "accession": "GCST90011807",
        "expected_min_ancestry_len": 1,
        "expected_min_EFO_len": 2,
        "expected_min_genotyping_technology": 1,
        "notes": "efo_trait:EFO_0002916|EFO_0000178",
        "api_call_from": "ingest_api",
    },
    {
        "case": 8,
        "accession": "GCST90435377",
        "expected_min_ancestry_len": 1,
        "expected_min_EFO_len": 2,
        "expected_min_genotyping_technology": 1,
        "notes": "efoTraits:[list,shortForm]",
        "api_call_from": "ingest_api",
    },
]
