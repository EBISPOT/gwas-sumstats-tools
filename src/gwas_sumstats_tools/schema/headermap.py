...
header_mapper = {
    ...
    # Odds ratio
    # ==========
    "odds_ratio": ["or", "odds_ratio", "oddsratio", "bcac_icogs1_or", "OR"],
    # Upper confidence interval
    # =========================
    "ci_upper": ["U95", "orupper", "u95"],
    # Lower confidence interval
    # =========================
    "ci_lower": ["L95", "orlower", "l95"],
    # Beta
    # ====
    "beta": [
        "b",
    ...
    # signed statistics
    # =================
    "z-score": ["zscore", "z_score", "z-score", "gc_zscore", "z", "Z", "ZSCORE"],
}
